...
function renderCartItems() {
    ...
    if (products === undefined || products.length === 0) {
        total_inner.innerHTML = `<p class="text-center">There are no products in your shopping cart.</p>`;
        ...
        total_inner.innerHTML = `Total Money: ${formatter.format(total)}`;
    ...
    let contents = `
        <div class="card" style="width: 18rem;" data-aos="fade-left">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary btn-sm" id="addCart" data-code="${product.code}">Add To Cart</button>
            </div>
        </div>`;
...
function addToCart() {
    ...
    alert('Add Products To Cart Successfully !');
